...
contract CEFSToken is StandardToken {
  string public constant standard = "ERC20";
  string public constant name = "CryptopiaFeeShare";
  string public constant symbol = "CEFS";
  uint8 public constant decimals = 8;

  function CEFSToken() public {
    uint256 INITIAL_SUPPLY = 6300 * (10 ** uint256(decimals));
