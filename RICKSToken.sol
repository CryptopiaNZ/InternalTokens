...
contract PickeRicks is StandardToken {
  string public constant standard = "ERC20";
  string public constant name = "PickeRicks";
  string public constant symbol = "RICKS";
  uint8 public constant decimals = 8;

  function PickeRicks() public {
    uint256 INITIAL_SUPPLY = 4000000 * (10 ** uint256(decimals));
